...
set hidden
set visualbell
" set number  # Disabled by Dror - Numbers on each line are awkard for me
set nobackup
set noswapfile
set noshowmode
...
" Addition to make vim move one word at a time just like the Mac Terminal does
 let tp=$TERM_PROGRAM
if tp == 'iTerm.app'
  :" map Mac OS X iTerm.app
